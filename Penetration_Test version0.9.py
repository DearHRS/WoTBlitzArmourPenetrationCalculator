...
while 1:
    ...
    if tier == '9':
        if tank_type == 'all':                                                                          #armor test against all tank types
            ...
            tier9_ = tier9[: tier9.index('mt')]                                                           #striping tier 9 data to only light tanks
            for i in range(0, len(tier9_)):
                if tier9_[i] == 'lt':
                    print('________________[Against Light Tanks]________________')
                    print()
                else:
                    name_of_tank, caliber, s_shell, s_penetration, p_shell, p_penetration = tier9_[i].split(',')
                    #s_shell = standard shell, s_penetration = standard penetration, p_shell = premium shell, p_penetration = premium penetration   
                    details(name_of_tank, caliber, s_shell, s_penetration, p_shell, p_penetration)
            
        elif tank_type == 'mt':                                                                         #armor test against medium tanks
            tier9_ = tier9[tier9.index('mt') : tier9.index('ht')]                                        #striping tier 9 data to only medium tanks
            for i in range(0, len(tier9_)):
                if tier9_[i] == 'mt':
                    print('________________[Against Medium Tanks]________________')
                    print()
            ...
            tier9_ = tier9[tier9.index('ht') : tier9.index('td')]                                        #striping tier 9 data to only heavy tanks
            for i in range(0, len(tier9_)):
                if tier9_[i] == 'ht':
                    print('________________[Against Heavy Tanks]________________')
                    print()
            ...
            tier9_ = tier9[tier9.index('td') :]                                                          #striping tier 9 data to only heavy tanks
            for i in range(0, len(tier9_)):
                if tier9_[i] == 'td':
                    print('_____________[Against Tank destroyers]_______________')
                    print()
        ...
        if tank_type == 'all':                                                                          #armor test against all tank types
            ...
            tier10_ = tier10[: tier10.index('mt')]                                                           #striping tier 10 data to only light tanks
            for i in range(0, len(tier10_)):
                if tier10_[i] == 'lt':
                    print('________________[Against Light Tanks]________________')
                    print()
                else:
                    name_of_tank, caliber, s_shell, s_penetration, p_shell, p_penetration = tier10_[i].split(',')
                    #s_shell = standard shell, s_penetration = standard penetration, p_shell = premium shell, p_penetration = premium penetration   
                    details(name_of_tank, caliber, s_shell, s_penetration, p_shell, p_penetration)
            
        elif tank_type == 'mt':                                                                         #armor test against medium tanks
            tier10_ = tier10[tier10.index('mt') : tier10.index('ht')]                                    #striping tier 10 data to only medium tanks
            for i in range(0, len(tier10_)):
                if tier10_[i] == 'mt':
                    print('________________[Against Medium Tanks]________________')
                    print()
            ...
            tier10_ = tier10[tier10.index('ht') : tier10.index('td')]                                    #striping tier 10 data to only heavy tanks
            for i in range(0, len(tier10_)):
                if tier10_[i] == 'ht':
                    print('________________[Against Heavy Tanks]________________')
                    print()
            ...
            tier10_ = tier10[tier10.index('td') :]                                                          #striping tier 10 data to only heavy tanks
            for i in range(0, len(tier10_)):
                if tier10_[i] == 'td':
                    print('_____________[Against Tank destroyers]_______________')
                    print()
